---
title: XYZ Site - Day 21 - Publish another Lexicon and Update a Markdown Post in ATProto
description: "Getting a test blog post in my PDS with a new Lexicon, newly published"
date: 2026-06-25 21:01:43.10 -4
tags:
  - 11ty
  - Node
  - SSG
...
Ok, I was able to [publish the three most necessary Lexicons](https://pdsls.dev/at://did:plc:kfxbexqtvw76572grhv2f3on/com.atproto.lexicon.schema).

Now I want to get the others in!

### Publishing BaseBlocks Lexicon
...
Hmmm, [let's check the bluesky reference](https://github.com/bluesky-social/atproto/blob/main/lexicons/app/bsky/richtext/facet.json) in their lexicons and compare. Also, [look at an example of them in action](https://getskyscraper.com/blog/bluesky-facets-rich-text-guide).
...
### Publishing a Standard Site Post Manually
...
It has all the right values now! And my social shares [are using the standard.site cards](https://bsky.app/profile/chronotope.aramzs.xyz/post/3mp65xzncz22m), which is really cool!
